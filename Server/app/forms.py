...
class CreateTrainingRoom(Form):
    ...
    facilities = SelectMultipleField('facilities', choices=[('M', 'Microphone'), ('D', 'DVD player'),
                                                            ('P', 'Projector'), ('I', 'Interactive white board'), ('L', 'Lectern'), ('C', '"Chalkboard'), ('S', 'Computer suite.')])
...
class CreateClass(Form):
    ...
    room = SelectField('room', coerce=int, choices=[],
                       validators=[InputRequired()])
    reqFac = SelectMultipleField('reqFac', choices=[('M', 'Microphone'), ('D', 'DVD player'), ('P', 'Projector'), (
        'I', 'Interactive white board'), ('L', 'Lectern'), ('C', 'Chalkboard'), ('S', 'Computer suite')])
    preReqs = SelectMultipleField('preReqs', coerce=int, choices=[])


class CreateClassDate(Form):
    dateYear = SelectField('dateYear', coerce=int, choices=[(
        2017, '2017'), (2018, '2018'), (2019, '2019'), (2020, '2020')], validators=[InputRequired()])
